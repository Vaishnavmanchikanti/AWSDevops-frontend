...
export default function ProgramBenefits() {
  const benefits = [
    ...
    },
    {
      ...
      description: "Get end-to-end experience by completing a capstone project that simulates a real-time AWS DevOps implementation. Work with both structured and semi-structured data in real-world scenarios.",
    ...
    },
    {
      ...
      description: "Get personalized career guidance with exclusive 1-to-1 sessions with our expert trainer. We'll support you at every step of your AWS DevOps  career journey, from resume building and mock interviews to certification prep and job search strategies.",
      bgColor: "bg-accent/10",
      iconColor: "text-accent",
    ...
    <section id="program" className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground">Four compelling reasons to start your AWS DevOps journey with us</p>
        </div>
